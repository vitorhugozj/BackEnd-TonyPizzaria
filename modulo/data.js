...
const getClientes = function(nomeDoCliente){
    const jsonClientes = {}
    let nomeCliente = nomeDoCliente.toLowerCase()
    let status = false

    clientes.data.forEach(clientes => {
        if (nomeCliente == clientes.nome.toLowerCase()) {
            jsonClientes.nome = clientes.nome
            jsonClientes.email = clientes.email
            jsonClientes.senha = clientes.senha
            jsonClientes.telefone = clientes.telefone
            jsonClientes.endereco = clientes.endereco
            status = true
        }
    })
    if(status == true){
...
const getCategoriaProdutos = function(){
    ...
    categoriasProdutos.array.forEach(categorias => {
...
const getProdutos = function(){
    ...
    jsonProdutos.data = arrayProdutos
    if (status == true) {
        return jsonProdutos
    }
    else{
...
const getProduto = function(produtoEscolhido){
    const arrayProduto = produtoEscolhido.toLowerCase()
    const jsonProduto = {}
    let status = false

    produtos.data.forEach(produtos => {
        if (arrayProduto == produtos.titulo.toLowerCase()) {
            ...
            jsonProduto.imagem = produtos.imagem
...
const getComentarioUsuarios = function(){
    ...
    comentarioUsuario.data.forEach(comentarioUsuario => {
        arrayComentario.push(comentarioUsuario)
        status = true
    }) 
    jsonComentario.data = arrayComentario
    if (status == true) {
